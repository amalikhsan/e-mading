        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="container my-5">
                    <img src="assets/public/img/slides.png" class="img-responsive rounded-4 w-100 shadow">
                </div>
            </div>
            <div class="carousel-item">
                <div class="container my-5">
                    <img src="assets/public/img/slides1.png" class="img-responsive rounded-4 w-100 shadow">
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            ?>
                                <div class="col-12 mb-3" data-aos="zoom-in" data-aos-duration="1000" style="cursor:pointer;" onclick="location='?page=berita&detail=<?= $d['judul_berita'] ?>'">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            while ($d = mysqli_fetch_assoc($result)) {
                            ?>
                                <div class="col-12 mb-3" data-aos="zoom-in" data-aos-duration="1300" style="cursor:pointer;" onclick="location='?page=berita&detail=<?= $d['judul_berita'] ?>'">
