    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row">
                ...
                ?>
                    <div class="col-12 mb-3" data-aos="fade-right" data-aos-duration="1000" style="cursor:pointer;" onclick="location='?page=berita&detail=<?= $d['judul_berita'] ?>'">
...
?>
    <!-- 1 data -->
    <?php
    $result = $db->getBerita3(@$_GET["detail"]);
    while ($d = mysqli_fetch_assoc($result)) {
    ?>
        <section class="py-5">
            <div class="container">
                    ...
                    <div class="col-12" data-aos="fade-down" data-aos-duration="1300">
                        <div class="card border-0 shadow rounded-4">
                            <div class="card-header bg-white border-0 rounded-4">
                                <a href="https://wa.me/?text=https://<?= $_SERVER["HTTP_HOST"] ?>/?page=berita%26detail=<?= $d["judul_berita"] ?>" class="float-end">Share<i class="bi bi-share ms-2"></i></a>
