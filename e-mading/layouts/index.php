                ...
                <div class="col-12 col-md-6" data-aos="fade-up" data-aos-duration="1300">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <ul class="list mb-lg-3">
                                <li><a href="" class="text-decoration-none text-secondary"><i class="bi bi-instagram me-2"></i>Instagram</a></li>
                                <li><a href="" class="text-decoration-none text-secondary"><i class="bi bi-whatsapp me-2"></i>Whatsapp</a></li>
                                <li><a href="" class="text-decoration-none text-secondary"><i class="bi bi-facebook me-2"></i>Facebook</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <form action="" method="post" class="d-flex rounded-pill border-2">
                                <input type="email" name="email" class="form-control border-primary shadow-none rounded-0 rounded-end rounded-pill ps-3" placeholder="Email">
