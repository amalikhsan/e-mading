...
(function(n) {
    ...
    D.ext.buttons.copyHtml5 = {
        className: "buttons-copy btn btn-primary rounded-0 rounded-top mb-1 me-2 float-start",
        text: function(a) { return a.i18n("buttons.copy", "Salin") },
    ...
    D.ext.buttons.csvHtml5 = {
        bom: !1,
        className: "buttons-csv btn btn-primary rounded-0 rounded-top mb-1 me-2 float-start",
        available: function() { return u.FileReader !== B && u.Blob },
        text: function(a) { return a.i18n("buttons.csv", "Download CSV") },
        action: function(a, c, d, b) {
            this.processing(!0);
            a = S(c, b).str;
    ...
    D.ext.buttons.excelHtml5 = {
        className: "buttons-excel btn btn-primary rounded-0 rounded-top mb-1 me-2 float-start",
    ...
    D.ext.buttons.pdfHtml5 = {
        className: "buttons-pdf btn btn-primary rounded-0 rounded-top mb-1 me-2 float-start",
        available: function() {
            return u.FileReader !==
                B && (F || u.pdfMake)
        },
        text: function(a) { return a.i18n("buttons.pdf", "Download Pdf") },
        action: function(a, c, d, b) {
            this.processing(!0);
